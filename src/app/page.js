						...
						>
							<div className='md:col-span-2'>
								<h1 className='text-center md:text-left text-3xl font-medium text-neutral-800 md:text-3xl  lg:text-6xl lg:leading-snug'>
									...
									<span className='font-bold text-[#229FFF]'>easy design</span>{" "}
									and deploy{" "}
							...
							<div className='group relative z-10  w-full h-full flex items-center justify-center flex-col gap-3 cursor-pointer  text-center'>
								<Link href='/signup'>
				...
				<div className='w-10/12 flex flex-col md:flex-row px-4 md:px-24 py-6 md:py-10 gap-8 md:gap-20'>
					<div className='flex flex-col w-full md:w-4/12 p-6 justify-center gap-5'>
						...
						<p className='text-gray-800'>
							Built in drag and drop functionality provided in the forms builder
							page to let users make form easy with just simple drag and drop
						</p>
					</div>
